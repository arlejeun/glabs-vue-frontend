...
<template>
  <header class="navbar-light header-sticky">
    <!-- Logo Nav START -->
    <nav class="navbar navbar-expand-xl bg-primary pt-0">
      <div class="container">
        <!-- Logo START -->
        ...
        <div class="navbar-collapse collapse" id="navbarCollapse">
          <ul class="navbar-nav navbar-nav-scroll" :class="{ 'bg-secondary': isMobile }">

            <!-- Nav item Listing -->
            <li class="nav-item dropdown">
              <router-link class="nav-link text-white fw-bolder" to="workshops">Workshops</router-link>
            </li>
        ...
        <ul class="nav flex-row align-items-center list-unstyled ms-xl-auto">
          ...
          <li class="nav-item ms-3 dropdown">
            ...
            <ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3"
              ...
              <li>
                <router-link class="dropdown-item" to="profile"><i class="bi bi-bookmark-check fa-fw me-2"></i>My
                  Profile</router-link>
              </li>
