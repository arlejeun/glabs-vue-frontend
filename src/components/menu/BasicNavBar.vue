        ...
        <div class="navbar-collapse collapse" id="navbarCollapse">
          <ul class="navbar-nav navbar-nav-scroll">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link text-white fw-bolder" href="#" aria-haspopup="true" aria-expanded="false">Workshops</a>
            </li>

            <li class="nav-item dropdown">
              <a class="nav-link text-white fw-bolder" href="#" aria-haspopup="true" aria-expanded="false">Environments</a>
            </li>
